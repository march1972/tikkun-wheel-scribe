...
function HistoryPage() {
  ...
  return (
    <SkyShell starDensity={240}>
      <section
        className="relative px-[clamp(1.25rem,5vw,3rem)] pt-[clamp(2.5rem,6vh,4.5rem)] pb-[clamp(3rem,6vh,5rem)]"
        style={{ background: C_BAND_DEEP, borderTop: `1px solid ${C_RULE_SOFT}` }}
      >
        <div className="relative mx-auto max-w-2xl">
          <Reveal>
            <p style={{ fontFamily: BODY, color: C_INK_SOFT, fontSize: "15px", lineHeight: 1.7 }}>
          ...
          <Reveal delay={120}>
            <p className="mt-6" style={{ fontFamily: BODY, color: C_INK_SOFT, fontSize: "15px", lineHeight: 1.7 }}>

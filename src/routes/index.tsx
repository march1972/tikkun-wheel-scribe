...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Free Kabbalah Birth Chart & Tikkun Reading" },
      {
        name: "description",
        content:
          "Free Kabbalah Astrology calculator. Enter your date of birth to reveal your Kabbalistic birth chart, Soul's Shadow, Tikkun, and daily Kavanah.",
      },
      ...
      <div className="relative">
          ...
          <div className="mx-auto mt-[clamp(1rem,2vh,1.5rem)] text-center">
            <Link
              ...
              style={{
                ...
                textTransform: "uppercase",
                fontWeight: 600,
                textShadow: "0 0 6px rgba(255, 233, 184, 0.35)",
              }}
              className="inline-block transition-all duration-300 hover:!text-[#f0c868] hover:scale-105 hover:drop-shadow-[0_0_14px_rgba(240,200,104,0.95)]"
            >
        ...
        >
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            >
              {[
                { letter: "ג", letterColor: C_DAWN, accent: C_GOLD, title: "Your Soul's Shadow Patterns", body: "The default habits and reactive patterns carried over from past lifetimes (Gilgulim) you are here to correct.", tint: "rgba(240, 200, 104, 0.06)" },
                { letter: "ת", letterColor: C_DAWN, accent: C_GOLD, title: "Your Spiritual Work (Tikkun)", body: "The active spiritual work, conscious restrictions, and real-world responsibilities required for your soul's growth.", tint: "rgba(240, 200, 104, 0.06)" },
                { letter: "ק", letterColor: C_DAWN, accent: C_GOLD, title: "Your Daily Mantra (Kavanah)", body: "Words to\u00A0meditate on to restrict your ego and reactivity, and direct your intention towards your Tikkun.", tint: "rgba(240, 200, 104, 0.06)" },
              ].map((item, idx) => {
                return (
        ...
        >
          ...
          <div className="relative mx-auto max-w-2xl text-center">
            ...
            <Reveal delay={140}>
              ...
              >
                Kabbalistic Astrology dates back to <span style={{ color: C_DAWN, fontStyle: "italic" }}>Abraham the Patriarch</span> and many ancient texts — the Talmud (the Oral Torah), Sefer Yetzirah (Book of Formation), and Zohar (Book of Splendor).
              </p>
            </Reveal>
          </div>
        </section>

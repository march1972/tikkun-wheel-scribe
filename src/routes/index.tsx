      ...
      <div className="relative">
        ...
        >
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            >
              A free <span style={{ color: C_GOLD, fontStyle: "italic" }}>Tikkun</span> reading based on the lunar nodes on your birthdate. To see your recurring patterns, and what to correct.
            </p>

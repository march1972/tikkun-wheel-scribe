...
const C_DAWN = "#e94e2b";           // visible red-orange accent
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            >
              {[
                ...
                { letter: "מ", letterColor: "#ff6a4a", accent: "#FFE9B8", title: "Your Aramaic letter and emotion", body: "the sacred letter and inner quality assigned to your path.", tint: "rgba(255, 233, 184, 0.06)" },
                { letter: "ש", letterColor: "#ff6a4a", accent: "#FFE9B8", title: "A daily mantra and reflection",   body: "a verse to carry, and a prompt to sit with.", tint: "rgba(255, 233, 184, 0.06)" },
              ].map((item) => {
                return (
                  <li
                    key={item.title}

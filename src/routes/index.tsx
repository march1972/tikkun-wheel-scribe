      ...
      <div className="relative">
        ...
        >
          ...
          <div className="relative mx-auto max-w-3xl text-center">
            ...
            >
              {[
                { letter: "ג", letterColor: C_DAWN, accent: C_GOLD, title: "Your Shadow Patterns (Gilgul)", body: "The default negative habits and reactive patterns (\"baggage\") carried over from past lifetimes.", tint: "rgba(240, 200, 104, 0.06)" },
                { letter: "ת", letterColor: C_DAWN, accent: C_GOLD, title: "Your Spiritual Life's Work (Tikkun)", body: "The active spiritual work, conscious restrictions, and real-world responsibilities required for your soul's growth.", tint: "rgba(240, 200, 104, 0.06)" },
                { letter: "ק", letterColor: C_DAWN, accent: C_GOLD, title: "Your Daily Mantra (Kavanah)", body: "To restrict automatic reactions and direct your intention towards living your Tikkun.", tint: "rgba(240, 200, 104, 0.06)" },
              ].map((item, idx) => {
                return (
